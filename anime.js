...
exports.anime = async (bot, msg, PREFIX, message) => {
...
exports.addanime = async (bot, msg, PREFIX, message) => {
  {
    // GET user id
  ...
  exports.delanime = async (bot, msg, PREFIX, message) => {
    // Get user id
  ...
  exports.myanimelist = async (bot, msg, PREFIX, message) => {
    // Get user id
